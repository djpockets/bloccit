...
RSpec.describe Api::V1::PostsController, type: :controller do
  ...
  context "authenticated and authorized users" do
    ...
    describe "PUT update" do
      before { put :update, topic_id: my_topic.id, id: my_post, post: {title: @new_post.title, body: @new_post.body} }
    ...
    describe "POST create" do
      before { post :create, topic_id: my_topic, post: {title: @new_post.title, body: @new_post.body} }
    ...
    describe "DELETE destroy" do
      before { delete :destroy, topic_id: my_topic.id, id: my_post }
